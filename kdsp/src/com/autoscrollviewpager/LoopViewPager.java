...
public class LoopViewPager extends ViewPager {
    ...
    private int mDownX, mDownY;                                 //按下的x,y坐标
    private ViewParent mViewParent;                             //父布局
...
//                mPreviousOffset = positionOffset;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        try {       //捕获 IllegalArgumentException : pointerIndex out of range 异常
    ...
    private void disallowParentTouchEvent(boolean disallow) {
        if (mViewParent != null) {
            ...
            //如果某些界面没办法设置viewparent 则取外面第一层父布局
            if (getParent() != null) {
