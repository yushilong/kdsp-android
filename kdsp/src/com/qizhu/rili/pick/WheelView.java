...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.text_size_5);
    ...
    private void initPaints() {
        ...
        paintOuterText.setTextScaleX(0.5F);
        ...
        paintCenterText.setTextScaleX(0.5F);
    ...
    private void remeasure() {
        ...
        //计算两条横线和控件中间点的Y位置
        firstLineY = (measuredHeight - itemHeight - 30) / 2.0F;
        secondLineY = (measuredHeight + itemHeight + 30 ) / 2.0F;
        centerY = (measuredHeight + maxTextHeight) /2.0F -20- CENTERCONTENTOFFSET;
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    canvas.scale(1F, (float) Math.sin(radian) * 1F);
                    ...
                    canvas.scale(1F, (float) Math.sin(radian) * SCALECONTENT);
                    canvas.drawText(contentText, drawOutContentStart, maxTextHeight, paintOuterText);
                    canvas.restore();
                    ...
                    contentText.length();
                    String newString = contentText;
                    float textWidth =  paintCenterText.measureText(contentText);
                    if (textWidth > measuredWidth) {
                        int subIndex =   paintCenterText.breakText(contentText,0,contentText.length(),true,measuredWidth,null);
                        newString = contentText.substring(0,subIndex)+"...";
                        drawCenterContentStart = drawCenterContentStart + 40;
                    }

                    canvas.drawText(newString, drawCenterContentStart, maxTextHeight - CENTERCONTENTOFFSET, paintCenterText);
